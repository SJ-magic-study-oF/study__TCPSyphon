...
void ofApp::setup(){
	...
	********************/
	...
	client_direct.setup();
	// client_direct.set("Screen Output","syphon_send"); // void set(string _serverName, string _appName);
	client_direct.set("Default","TCPSyphonClient"); // void set(string _serverName, string _appName);
